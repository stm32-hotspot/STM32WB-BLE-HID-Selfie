...
#ifdef ST_SELFIE
static const char a_LocalName[] = {AD_TYPE_COMPLETE_LOCAL_NAME,'S','T','_','H','I','D'};
#else
...
#ifdef ST_SELFIE
    UTIL_SEQ_SetTask(1<<CFG_TASK_SW1_ID, CFG_SCH_PRIO_0);
#else
...
void APP_BLE_Key_Button2_Action(void)
{
  ...
  if((t1 - t0) > BOUNCE_THRESHOLD)
  {
    UTIL_SEQ_SetTask(1<<CFG_TASK_SW2_ID, CFG_SCH_PRIO_0);
  }
#else
